...
<?php echo $this->Form->create('Type', array('url' => array('controller' => 'Format', 'action' => 'submit_choice'), 'id'=>'form_type', 'type'=>'file','class'=>'','method'=>'POST','autocomplete'=>'off','inputDefaults'=>array(
...
$(document).ready(function(){
	...
	$(".showDialog").each(function() {
		...
		currentElement.popover({
			content: function() {
				return currentElement[0].textContent
			},
			trigger: 'hover',
			html: true,
			placement: 'right'
